...
<head>
	...
	<link rel="stylesheet" href="{{ asset('public/Login_Assets/formlogin.css ')}}">
	<link rel="stylesheet" href="{{ asset('public/Login_Assets/formmediya.css') }}">
			...
			<form action="/register" method="POST">
                ...
                <a href="{{ url('authorized/google') }}">
                    <div class="logo1">
                        ...
                        <img src="{{ asset('public/Login_Assets/image/search.png')}}" height="20px" width="20px">
		...
		<div class="overlay-container">
			<div class="overlay">
				<div class="overlay-panel overlay-left">
					...
					<img src="{{ asset('public/Login_Assets/image/logoin-ff-removebg-preview.png') }}" alt="">
